...
## Number of columns == na_gears.
   ...
   0.000  0.000  0.000      ## Small constant to add to comps & renormalize
    1      1      1         ## phase for log_age_tau2 estimation.
    1      1      1         ## phase for phi1 estimation: bounded (-1,1) AR1
    1      1      1         ## phase for phi2 estimation: bounded (0,1)  AR2 
...
## ------------------------------------------------------------------------- ##
  1       1       8       6       6       # 1  -selectivity type ivector(isel_type) for gear
  ...
  2       2       2       -2      -2      # 6  -Phase of estimation (-1 for fixed)
...
0.95        # 13 -fraction of total mortality that takes place prior to spawning
