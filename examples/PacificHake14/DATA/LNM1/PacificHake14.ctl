...
## ------------------------------------------------------------------------- ##
	13 	  	1	        # 1  -selectivity type ivector(isel_type) for gear
	2	  	2.5	        # 2  -Age/length at 50% selectivity (logistic) or agemin
	6   	0.45	    # 3  -STD at 50% selectivity (logistic) or agemax
