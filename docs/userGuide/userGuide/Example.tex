...
\input{../srcWorkingCopy/Examples/NamibianHake/NamibianHake.ctl}
\end{alltt}
\hrulefill
\normalsize
...
\input{../srcWorkingCopy/Examples/NamibianHake/NamibianHake.dat}
\end{alltt}
\hrulefill
\normalsize
...
\noindent \hrulefill
\begin{alltt}
\input{../srcWorkingCopy/Examples/PacificHake/PHake2010.ctl}
\end{alltt}
\hrulefill
\normalsize
...
\tiny
\begin{alltt}
  \input{../srcWorkingCopy/Examples/PacificHake/PHake2010.dat}\label{HakeDataFile}
\end{alltt}
\normalsize
