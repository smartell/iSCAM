...
\title{
\vfill
Technical Documentation for the integrated statistical catch age model\\
\vfill
\includegraphics[height=2.53in]{iphclogo}
\vfill}

\author{Steven J. D. Martell and Catarina Wor Lima\\
