...
getArgsTMA2 <- function(input, prefix){
    ...
    argsTMA <- list(Dist_type=input[[paste0(prefix,"_","Dist_type")]],sprtarget=input[[paste0(prefix,"_","ni_sprTarget")]],intbl=input[[paste0(prefix,"_","tbl")]])
    print(argsTMA)
...
getResultAllocation <- function(Dist_type,sprtarget,intbl){
...
getResultAllocation2 <- function(Dist_type,sprtarget,intbl){
