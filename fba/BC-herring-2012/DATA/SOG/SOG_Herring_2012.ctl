...
## ival         lb      ub      phz     prior   p1      p2      #parameter   ##
   7.60        -5.0    15.0     4       0      -5.0     15      #log_ro      ##
   0.67         0.2     1.0     4       3      10.0     4.9254  #steepness   ##
   -0.7985077  -5.0     5.0     3       1      -0.7985  0.4     #log_m       ##
   7.40        -5.0    15.0     1       0      -5.0    15.0     #log_avgrec  ##
   7.20        -5.0    15.0     1       0      -5.0    15.0     #log_recinit ##
   0.3043478    0.001   0.999   3       3      17.0870 39.0559  #rho         ##
...
## ------------------------------------------------------------------------- ##
1       1       8       6       6       # -selectivity type ivector(isel_type) for gear
3.0     3.0     4.0     2.055   2.055   # -Age/length at 50% selectivity (logistic)
0.25    0.25    0.25    0.05    0.05    # -STD at 50% selectivity (logistic)
5       5       5       0       0       # -No. of age nodes for each gear (0=ignore)
12      3       10      0       0       # -No. of year nodes for 2d spline(0=ignore)
2       2       2       -2      -2      # -Phase of estimation (-1 for fixed)
125.0   125.0   12.5    12.5    12.5    # -Penalty wt for 2nd differences w=1/(2*sig^2)
50.0    50.0    200.0   200.0   200.0   # -Penalty wt for dome-shaped w=1/(2*sig^2)
## ------------------------------------------------------------------------- ##
##
##
##
