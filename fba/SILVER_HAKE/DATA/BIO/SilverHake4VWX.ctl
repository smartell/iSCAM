...
3.0		3.0     1   1   1       # -Age/length at 50% selectivity (logistic)
...
3.12	3.12	1.0	1	1		# -Penalty wt for dome-shaped w=1/(2*sig^2)
1.0		1.0		1   1   1       # -Penalty wt for 2nd diffs over time w=1/(2*sig^2) 
1       1       1   1   1 		# -Number of selectivity blocks
## ------------------------------------------------------------------------- ##
1977
1977
1977
...
2	0	0			# -prior type (see legend above)
...
0.9        # 13 -fraction of total mortality that takes place prior to spawning
