...
\title[\iscam]{Size limit effects on halibut CEY, spawning biomass, and commercial setline fishery wastage.}
...
\end{frame}
%
\begin{frame}[t]\frametitle{IPHC model is fit to}
	\begin{itemize}
		\item<+->  WPUE from setline survey
