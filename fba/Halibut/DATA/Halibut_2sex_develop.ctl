...
## ------------------------------------------------------------------------- ##
   15.18892     -5.0    15      1       0       -5.0    15      #log_recinit ##
   -0.82391     -3.0    2.0     -1      1       -1.74   0.1     #log_m_f     ##
...
## ------------------------------------------------------------------------- ##
   15.56507     -5.0    15      1       0       -5.0    15      #log_recinit ##
   -0.86814     -3.0    2.0     -1      1       -1.74   0.1     #log_m_f     ##
...
## ------------------------------------------------------------------------- ##
##comm  setl  sprt  pers  o32b  032w
  11    11    11    11    11    11    # -selectivity type ivector(isel_type) for gear
  65    65    65    65    82.3  82.3  # -Age/length at 50% selectivity (logistic)
  5     5     5     5     0.01  0.01  # -STD at 50% selectivity (logistic)
  ...
  2     2     2     2     2     2     # -Penalty wt for 2nd differences w=1/(2*sig^2)
  3     3     3     3     3     3     # -Penalty wt for dome-shaped w=1/(2*sig^2)
  81.3  0     0     0     0     0     # -Size limit (cm)
  0.17  0     0     0     0     0     # -Discard mortality rate
## ------------------------------------------------------------------------- ##
##
##
##
