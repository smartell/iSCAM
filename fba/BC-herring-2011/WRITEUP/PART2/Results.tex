...
\clearpage
\input{../TABLES/qPriorTables/tableRiskHG}
\input{../TABLES/qPriorTables/tableRiskPRD}
\input{../TABLES/qPriorTables/tableRiskCC}
\input{../TABLES/qPriorTables/tableRiskSOG}
\input{../TABLES/qPriorTables/tableRiskWCVI}
