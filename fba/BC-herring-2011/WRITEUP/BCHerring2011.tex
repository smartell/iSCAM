...
Part II: Stock Assessment and Management Advice for the British Columbia Pacific Herring Stocks\\\vfill 2011 Assessment and 2012 Forecasts
\vfill
}
...
\input{Appendix_iSCAMdescription}
...
%Decision table
Were not completely comfortable with the q estimates, but we believe the approach used to develop the informative prior for q is better than the ad hoc q=1 assumption.  Assuming q=1 is more conservative.
