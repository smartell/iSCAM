...
\begin{figure}[!tbh]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{../FIGS/fig:RefPointBias.png}
	\end{center}
...
\begin{figure}[!tbh]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{../FIGS/fig:RMSEdist.png}
	\end{center}
