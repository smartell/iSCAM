...
\begin{figure*}[!tbh]
	\begin{center}
		\includegraphics[angle=0,width=\textwidth]{./FIGS/FIGRetroSpectiveSSB.eps}
	\end{center}
...
\begin{figure*}[!tbh]
	\begin{center}
		\includegraphics[angle=0,width=\textwidth]{./FIGS/FIGRetroSquidBase.eps}
	\end{center}
...
\begin{figure*}[!tbh]
	\begin{center}
		\includegraphics[width=\textwidth]{./FIGS/FIGRefPointBias.eps}
	\end{center}
...
\begin{figure*}[!tbh]
	\begin{center}
		\includegraphics[width=\textwidth]{./FIGS/FIGRMSEdist.eps}
	\end{center}
